<template>
  <div class="view-cards">
    <div class="row no-gutters d-flex align-items-center">
      <div class="col-6">Видимость карточек</div>
      <div class="col-6">
        <oy-select :value="value" @change="onChange">
          <option :disabled="true" :selected="!ruleValue">Не указано</option>
          <option :selected="ruleValue === 'all'" value="all">Все</option>
          <option :selected="ruleValue === 'creator'" value="creator"
            >Собственные</option
          >
          <option :selected="ruleValue === 'lead'" value="lead">Ведуший</option>
          <option :selected="ruleValue === 'member'" value="member"
            >Участник</option
          >
